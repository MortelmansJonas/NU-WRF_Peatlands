...
# CREATE NETCDF FILE
# ---------------------------------------------------------------------------------------------
nf= '/scratch/leuven/336/vsc33651/nu-wrf-dev/wrfout_nc_files/Slave_lake_daily_0.1d.nc'
...
Flashdensity_CC = ds.createVariable('Flashdensity_CC', int, ( 'time', 'lat', 'lon',))
Flashdensity_CC.units = 'Amount/hour'
Flashdensity_CG = ds.createVariable('Flashdensity_CG', int, ( 'time', 'lat', 'lon',))
