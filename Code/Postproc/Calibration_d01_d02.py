...
ds = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/wrfout_nc_files/data_calibrated_ax_d01_Thompson.nc', mode='w', format='NETCDF4')
...
axes[0][0].plot(bins_PR92W_centered_G,n_PR92W_G,marker='v', ms=7, color=palette[2])
...
axes[0][1].plot(bins_PR92W_centered_T,n_PR92W_T,marker='v', ms=7, color=palette[2])
...
axes[1][0].plot(bins_PR92W_centered_d02_G,n_PR92W_d02_G,marker='v', ms=7, color=palette[2])
...
axes[1][0].set_xlabel('Flash density (# hr$^{-1}$ km$^{-2}$)', fontsize = 28)
...
axes[1][1].plot(bins_PR92W_centered_d02_T,n_PR92W_d02_T,marker='v', ms=7,  label='PR92W', color=palette[2])
axes[1][1].plot(bins_CAPExP_R_centered_d02_T,n_CAPExP_R_d02_T,marker='x', ms=7, label='CAPEXP_R', color=palette[3])
...
axes[1][1].set_xlabel('Flash density (# hr$^{-1}$ km$^{-2}$)', fontsize = 28)
axes[1][1].legend(bbox_to_anchor=(0.9, -0.5), ncol=6,fontsize=20)
