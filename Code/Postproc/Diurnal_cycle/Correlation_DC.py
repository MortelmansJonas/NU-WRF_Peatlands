...
# SEASONALITY
# ---------------------------------------------------------------------------------------------
# ds_d01_G = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/NU-WRF/wrfout_nc_files/d01_seasonality_72x72.nc', 'r')
# ds_d02_G = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/NU-WRF/wrfout_nc_files/d02_seasonality_72x72.nc', 'r')
# ds_d01_T = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/NU-WRF/wrfout_nc_files/d01_seasonality_72x72_Thompson.nc', 'r')
# ds_d02_T = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/NU-WRF/wrfout_nc_files/d02_seasonality_72x72_Thompson.nc', 'r')
#
# lat_d01 = ds_d01_T['lat'][:]
# lon_d01 = ds_d01_T['lon'][:]
#
...
# df.iloc[(15*length):(16*length),2] = R_CAPExP_R_d02_G.flatten()
#
# ax = sns.boxplot(x='sim', y='mean', hue='Parameterization', ax=axes[1], data=df, palette=palette)
# axes[1].set_title('Seasonality', fontsize=14)
