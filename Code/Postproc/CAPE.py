...
#Load the WRF File
wrfOutputFile = Dataset("/data/leuven/336/vsc33651/projects/nu-wrf-dev/testcases/wrflis/noahmp36_modis_merra2/wrfout_d01_2005-07-01_12:00:00")
...
myBaseMap = Basemap(projection='lcc',
                    lat_0 = lat_0,
                    lon_0 = lon_0,
                    llcrnrlat=min_lat,
                    urcrnrlat=max_lat,
