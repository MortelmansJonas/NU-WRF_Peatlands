...
outfile = '//scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/wrfout_nc_files/domain2_at_domain1_LPI.nc'
...
for t in range(7609,np.shape(ds02['LTG3'])[0]):
