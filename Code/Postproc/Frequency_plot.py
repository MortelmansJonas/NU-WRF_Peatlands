...
cond_PR92H_d01 = ds_d01['PR92H'][:] < 0.01
cond_PR92H_d02 = ds_d02['PR92H'][:] < 0.01
...
PR92H_n_d01[cond_PR92H_d01] = np.nan
PR92H_n_d02[cond_PR92H_d02] = np.nan
...
plt.close()
n_PR92H, bins_PR92H_log10, patches_PR92H = plt.hist(np.log10(PR92H_n_d01[PR92H_n_d01!=0]),bins=my_bins)
plt.close()
...
plt.close()
n_PR92H_d02, bins_PR92H_log10_d02, patches_PR92H_d02 = plt.hist(np.log10(PR92H_n_d02[PR92H_n_d02!=0]),bins=my_bins)
plt.close()
