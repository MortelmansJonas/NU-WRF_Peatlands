...
# ---------------------------------------------------------------------------------------------
print('load data')
ds_d02_in = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain2_all_v4.nc', mode='r')
ds_d01_in = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain1_all.nc', mode='r')
ds_obs_d01 = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/CLDN_at_domain1_all_v4.nc','r')
ds_obs_d02 = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/CLDN_at_domain2_all.nc','r')
...
# D01
ds_d01 = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain1_daily.nc', mode='w', format='NETCDF4')
...
# D02
ds_d02 = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain2_daily.nc', mode='w', format='NETCDF4')
...
for i in range(0,days):
    ...
    ds_d02['Obs'][i, :, :] = np.sum(L_d02[k:j, :, :], axis=0)
