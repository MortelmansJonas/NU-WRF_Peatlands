...
# LOAD DATA OF D02
# ---------------------------------------------------------------------------------------------
ds_d01_daily = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain1_daily.nc', mode='r')
ds_d02_daily = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain2_daily.nc', mode='r')
# ---------------------------------------------------------------------------------------------
# CREATE NC FILE
# ---------------------------------------------------------------------------------------------
...
ds_d01 = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain1_weekly.nc', mode='w', format='NETCDF4')
...
# D02
ds_d02 = Dataset('/scratch/leuven/336/vsc33651/nu-wrf-dev/domain2_weekly.nc', mode='w', format='NETCDF4')
