...
# LOAD DATA OF D02
# ---------------------------------------------------------------------------------------------
ds_d01_daily = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/wrfout_nc_files/domain1_daily_regridded.nc', mode='r')
ds_d02_daily = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/wrfout_nc_files/domain2_daily_regridded.nc', mode='r')
# ---------------------------------------------------------------------------------------------
# CREATE NC FILE
# ---------------------------------------------------------------------------------------------
...
ds_d01 = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/wrfout_nc_files/domain1_weekly_regridded.nc', mode='w', format='NETCDF4')
ds_d01.createDimension('weeks', 78)
ds_d01.createDimension('timeseries', 1951) # Keep daily data in case timeseries analysis is wanted
...
ds_d01.createVariable('CAPExP_R', 'f4', dimensions=('weeks',), zlib=True)
ds_d01.createVariable('CAPExP_CSI', 'f4', dimensions=('weeks',), zlib=True)
...
ds_d01.createVariable('data_CAPExP_R', 'f4', dimensions=('timeseries',), zlib=True)
ds_d01.createVariable('data_CAPExP_CSI', 'f4', dimensions=('timeseries',), zlib=True)
ds_d01.createVariable('data_Obs', 'f4', dimensions=('timeseries',), zlib=True)
# D02
ds_d02 = Dataset('/scratch/leuven/projects/lt1_2020_es_pilot/project_output/rsda/vsc33651/wrfout_nc_files/domain2_weekly_regridded.nc', mode='w', format='NETCDF4')
...
ds_d02.createVariable('CAPExP_R', 'f4', dimensions=('weeks',), zlib=True)
ds_d02.createVariable('CAPExP_CSI', 'f4', dimensions=('weeks',), zlib=True)
...
ds_d02.createVariable('data_CAPExP_R', 'f4', dimensions=('timeseries',), zlib=True)
ds_d02.createVariable('data_CAPExP_CSI', 'f4', dimensions=('timeseries',), zlib=True)
...
ds_d02['data_LTG3'][:] = 0
ds_d02['data_PR92W'][:] = 0
ds_d02['data_CAPExP_R'][:] = 0
ds_d02['data_CAPExP_CSI'][:] = 0
ds_d02['data_Obs'][:] = 0
ds_d01['data_LPI'][:] = 0
ds_d01['data_LTG3'][:] = 0
ds_d01['data_PR92W'][:] = 0
ds_d01['data_CAPExP_R'][:] = 0
ds_d01['data_CAPExP_CSI'][:] = 0
ds_d01['data_Obs'][:] = 0
...
print(np.nanmax(ds_d01['data_LPI'][:]))
# LPI DOMAIN 2
ds_d02['data_LPI'][i2015] = np.nanmean(ds_d02_daily['LPI'][0:92], axis=(1,2))
ds_d02['data_LPI'][i2016] = np.nanmean(ds_d02_daily['LPI'][92:184], axis=(1,2))
ds_d02['data_LPI'][i2017] = np.nanmean(ds_d02_daily['LPI'][184:276], axis=(1,2))
ds_d02['data_LPI'][i2018] = np.nanmean(ds_d02_daily['LPI'][276:368], axis=(1,2))
ds_d02['data_LPI'][i2019] = np.nanmean(ds_d02_daily['LPI'][368:460], axis=(1,2))
ds_d02['data_LPI'][i2020] = np.nanmean(ds_d02_daily['LPI'][460:552], axis=(1,2))
# LTG3 DOMAIN 1
print('LTG3 DATA')
ds_d01['data_LTG3'][i2015] = np.nanmean(ds_d01_daily['LTG3'][0:92], axis=(1,2))
ds_d01['data_LTG3'][i2016] = np.nanmean(ds_d01_daily['LTG3'][92:184], axis=(1,2))
ds_d01['data_LTG3'][i2017] = np.nanmean(ds_d01_daily['LTG3'][184:276], axis=(1,2))
ds_d01['data_LTG3'][i2018] = np.nanmean(ds_d01_daily['LTG3'][276:368], axis=(1,2))
ds_d01['data_LTG3'][i2019] = np.nanmean(ds_d01_daily['LTG3'][368:460], axis=(1,2))
ds_d01['data_LTG3'][i2020] = np.nanmean(ds_d01_daily['LTG3'][460:552], axis=(1,2))
# LTG3 DOMAIN 2
ds_d02['data_LTG3'][i2015] = np.nanmean(ds_d02_daily['LTG3'][0:92], axis=(1,2))
ds_d02['data_LTG3'][i2016] = np.nanmean(ds_d02_daily['LTG3'][92:184], axis=(1,2))
ds_d02['data_LTG3'][i2017] = np.nanmean(ds_d02_daily['LTG3'][184:276], axis=(1,2))
ds_d02['data_LTG3'][i2018] = np.nanmean(ds_d02_daily['LTG3'][276:368], axis=(1,2))
ds_d02['data_LTG3'][i2019] = np.nanmean(ds_d02_daily['LTG3'][368:460], axis=(1,2))
ds_d02['data_LTG3'][i2020] = np.nanmean(ds_d02_daily['LTG3'][460:552], axis=(1,2))
# PR92W DOMAIN 1
print('PR92W DATA')
ds_d01['data_PR92W'][i2015] = np.nanmean(ds_d01_daily['PR92W'][0:92], axis=(1,2))
ds_d01['data_PR92W'][i2016] = np.nanmean(ds_d01_daily['PR92W'][92:184], axis=(1,2))
ds_d01['data_PR92W'][i2017] = np.nanmean(ds_d01_daily['PR92W'][184:276], axis=(1,2))
ds_d01['data_PR92W'][i2018] = np.nanmean(ds_d01_daily['PR92W'][276:368], axis=(1,2))
ds_d01['data_PR92W'][i2019] = np.nanmean(ds_d01_daily['PR92W'][368:460], axis=(1,2))
ds_d01['data_PR92W'][i2020] = np.nanmean(ds_d01_daily['PR92W'][460:552], axis=(1,2))
# PR92W DOMAIN 2
ds_d02['data_PR92W'][i2015] = np.nanmean(ds_d02_daily['PR92W'][0:92], axis=(1,2))
ds_d02['data_PR92W'][i2016] = np.nanmean(ds_d02_daily['PR92W'][92:184], axis=(1,2))
ds_d02['data_PR92W'][i2017] = np.nanmean(ds_d02_daily['PR92W'][184:276], axis=(1,2))
ds_d02['data_PR92W'][i2018] = np.nanmean(ds_d02_daily['PR92W'][276:368], axis=(1,2))
ds_d02['data_PR92W'][i2019] = np.nanmean(ds_d02_daily['PR92W'][368:460], axis=(1,2))
ds_d02['data_PR92W'][i2020] = np.nanmean(ds_d02_daily['PR92W'][460:552], axis=(1,2))
# CAPExP_R DOMAIN 1
print('CAPExP_R DATA')
ds_d01['data_CAPExP_R'][i2015] = np.nanmean(ds_d01_daily['CAPExP_R'][0:92], axis=(1,2))
ds_d01['data_CAPExP_R'][i2016] = np.nanmean(ds_d01_daily['CAPExP_R'][92:184], axis=(1,2))
ds_d01['data_CAPExP_R'][i2017] = np.nanmean(ds_d01_daily['CAPExP_R'][184:276], axis=(1,2))
ds_d01['data_CAPExP_R'][i2018] = np.nanmean(ds_d01_daily['CAPExP_R'][276:368], axis=(1,2))
ds_d01['data_CAPExP_R'][i2019] = np.nanmean(ds_d01_daily['CAPExP_R'][368:460], axis=(1,2))
ds_d01['data_CAPExP_R'][i2020] = np.nanmean(ds_d01_daily['CAPExP_R'][460:552], axis=(1,2))
# CAPExP_R DOMAIN 2
ds_d02['data_CAPExP_R'][i2015] = np.nanmean(ds_d02_daily['CAPExP_R'][0:92], axis=(1,2))
ds_d02['data_CAPExP_R'][i2016] = np.nanmean(ds_d02_daily['CAPExP_R'][92:184], axis=(1,2))
ds_d02['data_CAPExP_R'][i2017] = np.nanmean(ds_d02_daily['CAPExP_R'][184:276], axis=(1,2))
ds_d02['data_CAPExP_R'][i2018] = np.nanmean(ds_d02_daily['CAPExP_R'][276:368], axis=(1,2))
ds_d02['data_CAPExP_R'][i2019] = np.nanmean(ds_d02_daily['CAPExP_R'][368:460], axis=(1,2))
ds_d02['data_CAPExP_R'][i2020] = np.nanmean(ds_d02_daily['CAPExP_R'][460:552], axis=(1,2))
# CAPExP_CSI DOMAIN 1
print('CAPExP_CSI DATA')
ds_d01['data_CAPExP_CSI'][i2015] = np.nanmean(ds_d01_daily['CAPExP_CSI'][0:92], axis=(1,2))
ds_d01['data_CAPExP_CSI'][i2016] = np.nanmean(ds_d01_daily['CAPExP_CSI'][92:184], axis=(1,2))
ds_d01['data_CAPExP_CSI'][i2017] = np.nanmean(ds_d01_daily['CAPExP_CSI'][184:276], axis=(1,2))
ds_d01['data_CAPExP_CSI'][i2018] = np.nanmean(ds_d01_daily['CAPExP_CSI'][276:368], axis=(1,2))
ds_d01['data_CAPExP_CSI'][i2019] = np.nanmean(ds_d01_daily['CAPExP_CSI'][368:460], axis=(1,2))
ds_d01['data_CAPExP_CSI'][i2020] = np.nanmean(ds_d01_daily['CAPExP_CSI'][460:552], axis=(1,2))
# CAPExP_CSI DOMAIN 2
ds_d02['data_CAPExP_CSI'][i2015] = np.nanmean(ds_d02_daily['CAPExP_CSI'][0:92], axis=(1,2))
ds_d02['data_CAPExP_CSI'][i2016] = np.nanmean(ds_d02_daily['CAPExP_CSI'][92:184], axis=(1,2))
ds_d02['data_CAPExP_CSI'][i2017] = np.nanmean(ds_d02_daily['CAPExP_CSI'][184:276], axis=(1,2))
ds_d02['data_CAPExP_CSI'][i2018] = np.nanmean(ds_d02_daily['CAPExP_CSI'][276:368], axis=(1,2))
ds_d02['data_CAPExP_CSI'][i2019] = np.nanmean(ds_d02_daily['CAPExP_CSI'][368:460], axis=(1,2))
ds_d02['data_CAPExP_CSI'][i2020] = np.nanmean(ds_d02_daily['CAPExP_CSI'][460:552], axis=(1,2))
# Obs DOMAIN 1
print('Obs DATA')
...
ds_d01['data_CAPExP_R'][:] = np.where(month == 6, ds_d01['data_CAPExP_R'][:],
                np.where(month == 7, ds_d01['data_CAPExP_R'][:],
                         np.where(month == 8, ds_d01['data_CAPExP_R'][:], np.nan)))
ds_d01['data_CAPExP_CSI'][:] = np.where(month == 6, ds_d01['data_CAPExP_CSI'][:],
                np.where(month == 7, ds_d01['data_CAPExP_CSI'][:],
                         np.where(month == 8, ds_d01['data_CAPExP_CSI'][:], np.nan)))
ds_d02['data_CAPExP_R'][:] = np.where(month == 6, ds_d02['data_CAPExP_R'][:],
                np.where(month == 7, ds_d02['data_CAPExP_R'][:],
                         np.where(month == 8, ds_d02['data_CAPExP_R'][:], np.nan)))
ds_d02['data_CAPExP_CSI'][:] = np.where(month == 6, ds_d02['data_CAPExP_CSI'][:],
                np.where(month == 7, ds_d02['data_CAPExP_CSI'][:],
                         np.where(month == 8, ds_d02['data_CAPExP_CSI'][:], np.nan)))
...
weekly_CAPExP_R_d01 = np.zeros((546))
weekly_CAPExP_R_d02 = np.zeros((546))
weekly_CAPExP_CSI_d01 = np.zeros((546))
weekly_CAPExP_CSI_d02 = np.zeros((546))
...
# CAPExP_R DOMAIN 1
print('weekly average CAPExP_R')
weekly_CAPExP_R_d01[0:91] = ds_d01['data_CAPExP_R'][17:108]
weekly_CAPExP_R_d01[91:182] = ds_d01['data_CAPExP_R'][383:474]
weekly_CAPExP_R_d01[182:273] = ds_d01['data_CAPExP_R'][748:839]
weekly_CAPExP_R_d01[273:364] = ds_d01['data_CAPExP_R'][1113:1204]
weekly_CAPExP_R_d01[364:455] = ds_d01['data_CAPExP_R'][1478:1569]
weekly_CAPExP_R_d01[455:546] = ds_d01['data_CAPExP_R'][1844:1935]
# CAPExP_CSI DOMAIN 1
print('weekly average CAPExP_CSI')
weekly_CAPExP_CSI_d01[0:91] = ds_d01['data_CAPExP_CSI'][17:108]
weekly_CAPExP_CSI_d01[91:182] = ds_d01['data_CAPExP_CSI'][383:474]
weekly_CAPExP_CSI_d01[182:273] = ds_d01['data_CAPExP_CSI'][748:839]
weekly_CAPExP_CSI_d01[273:364] = ds_d01['data_CAPExP_CSI'][1113:1204]
weekly_CAPExP_CSI_d01[364:455] = ds_d01['data_CAPExP_CSI'][1478:1569]
weekly_CAPExP_CSI_d01[455:546] = ds_d01['data_CAPExP_CSI'][1844:1935]
# CAPExP_R DOMAIN 2
print('weekly average CAPExP')
weekly_CAPExP_R_d02[0:91] = ds_d02['data_CAPExP_R'][17:108]
weekly_CAPExP_R_d02[91:182] = ds_d02['data_CAPExP_R'][383:474]
weekly_CAPExP_R_d02[182:273] = ds_d02['data_CAPExP_R'][748:839]
weekly_CAPExP_R_d02[273:364] = ds_d02['data_CAPExP_R'][1113:1204]
weekly_CAPExP_R_d02[364:455] = ds_d02['data_CAPExP_R'][1478:1569]
weekly_CAPExP_R_d02[455:546] = ds_d02['data_CAPExP_R'][1844:1935]
# CAPExP_CSI DOMAIN 2
print('weekly average CAPExP')
weekly_CAPExP_CSI_d02[0:91] = ds_d02['data_CAPExP_CSI'][17:108]
weekly_CAPExP_CSI_d02[91:182] = ds_d02['data_CAPExP_CSI'][383:474]
weekly_CAPExP_CSI_d02[182:273] = ds_d02['data_CAPExP_CSI'][748:839]
weekly_CAPExP_CSI_d02[273:364] = ds_d02['data_CAPExP_CSI'][1113:1204]
weekly_CAPExP_CSI_d02[364:455] = ds_d02['data_CAPExP_CSI'][1478:1569]
weekly_CAPExP_CSI_d02[455:546] = ds_d02['data_CAPExP_CSI'][1844:1935]
# Obs DOMAIN 2
print('weekly average LTG')
...
for i in range(0,78):
    ...
    ds_d01['CAPExP_R'][i] = np.nanmean(weekly_CAPExP_R_d01[k:j])
    ds_d01['CAPExP_CSI'][i] = np.nanmean(weekly_CAPExP_CSI_d01[k:j])
    ds_d02['CAPExP_R'][i] = np.nanmean(weekly_CAPExP_R_d02[k:j])
    ds_d02['CAPExP_CSI'][i] = np.nanmean(weekly_CAPExP_CSI_d02[k:j])
